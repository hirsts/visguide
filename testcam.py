...
def capture_image():
    ...
    logger.debug("TIMING:Start TYPE:Sub Func DESC:Read image RESULT:None")
    ret, frame = cap.read()
    logger.debug("TIMING:End TYPE:Sub Func DESC:Read image RESULT:Image read")
    if ret:
